...
<header>↑ Drag Automorphic into the list above</header>
<button id="app" draggable="true" aria-label="Drag Automorphic to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">Automorphic</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged Automorphic icon is missing.");
