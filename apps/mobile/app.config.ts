    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Automorphic agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Automorphic to connect to Automorphic servers on your local network or tailnet.",
      NSPhotoLibraryAddUsageDescription: "Allow Automorphic to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow Automorphic to use your microphone for voice input.",
    ...
    [
      ...
      {
        cameraPermission:
          "Allow Automorphic to access your camera so you can scan pairing QR codes.",
