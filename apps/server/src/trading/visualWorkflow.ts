...
Design references: [Vercel Geist](https://vercel.com/geist/colors) and [Vercel's interface guidelines](https://vercel.com/design/guidelines). [Vercel Labs json-render](https://github.com/vercel-labs/json-render) is an optional catalog-driven UI architecture, not a tool installed by this skill. The bundled local stylesheet requires no hosted generator or runtime dependency.
