...
import { useDefaultTradingWorkspacePanel } from "../components/trading/tradingWorkspacePanel";
...
function ChatThreadRouteView() {
  ...
  useDefaultTradingWorkspacePanel(threadRef, serverThreadShell?.projectId ?? null);
