      ...
      <TooltipTrigger
        render={
          <button
            ...
            onClick={onClick}
            className={cn(
              "flex size-8 shrink-0 items-center justify-center rounded text-zinc-400 hover:bg-white/10 hover:text-white disabled:opacity-30",
            ...
            <>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-1 rounded bg-white/10 px-2 py-1.5 text-xs"
                >
