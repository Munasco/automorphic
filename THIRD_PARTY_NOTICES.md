...
The trading-graph icon is by [Streamline](https://github.com/webalys-hq/streamline-vectors), from the Freehand free icons collection, retrieved through [Iconify](https://api.iconify.design/streamline-freehand/trading-graph.svg). It is licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). SVG attributes were adapted for React; the artwork is unchanged.
